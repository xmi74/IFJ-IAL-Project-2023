...
/**
 * @brief Spracovanie escape sekvencie
 * 
 * @param c ukazatel na spracovavany charakter
*/
void handleEscapeSequence(int *c);

/**
 * @brief Priradenie klucoveho slova ci identifikatoru
 * 
 * @param token ukazatel na token, ktoreho struktury bude priradeny typ
 * @param identifier spracovavany retazec
*/
